        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <h3 class="col-lg-12">
                        {{$new->news_date}} {{$new->title}} <span style="display: inline;">
                ...
                <div class="col-lg-2">
                    ...
                    <label class="col-lg-10" style="font-size: 12px"> {{$new->author}}</label>
                        ...
                        <p class="col-lg-12" style="font-size: 24px">
                            ...
                            @foreach($new->games as $games_tag)<span class="label label-info" style="color: black; font-weight: lighter; font-size: 14px">{{$games_tag->game_date}}</span> @endforeach
                            ...
                            @foreach($new->rosters as $roster_tag)<span class="label label-info" style="color: black; font-weight: lighter; font-size: 14px">{{$roster_tag->first_name}}</span> @endforeach
                        </p>
                </td>
                 </tr>
                @endforeach
